        ...
        <x-submit-message />
                <form class="row" wire:submit.prevent="create" method="POST">
                    ...
                    <div class="col-md-12">
                                ...
                                <select wire:model="category_id" class="form-control {{$errors->has('category_id') ? 'is-invalid':''}}">
                    ...
                    <div class="col-md-12">
                                ...
                                <select wire:model="category_type_id" class="form-control {{$errors->has('category_type_id') ? 'is-invalid':''}}">
                                        <option value="">Select</option>
                    ...
                    <div class="col-md-12">
                                ...
                                <input type="text" class="form-control {{$errors->has('owner') ? 'is-invalid':''}}" wire:model="owner">
                                @error('owner') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="col-md-12">
                                <label class="label">Company</label>
                                <input type="text" class="form-control {{$errors->has('company') ? 'is-invalid':''}}" wire:model="company">
                                @error('company') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="col-md-12">
                                <label class="label">Valid from</label>
                                <input type="date" class="form-control {{$errors->has('start_date') ? 'is-invalid':''}}" wire:model="start_date">
                                @error('start_date') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="col-md-12">
                                <label class="label">Valid to</label>
                                <input type="date" class="form-control {{$errors->has('end_date') ? 'is-invalid':''}}" wire:model="end_date">
