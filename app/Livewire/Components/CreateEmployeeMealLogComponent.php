    ...
    public function updatedBarcodeValue()
    {
        ...
        try {
            ...
            if (date('Y-m-d') <= $barcode_data->end_date) {
                ...
                } elseif ($barcode_data->category_id == 1 && $barcode_data->category_type_id != 16 && in_array($this->meal_type, ['1', '3'])) {
                    $this->warningMessage = 'Meal Not Added! Barcode is not eligible for breakfast and dinner.';
                } else {
